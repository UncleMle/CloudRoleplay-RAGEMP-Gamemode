    ...
    <div v-if="hudState && keys[0].alt" style="position:absolute;">
        <div class="buttons" style="margin-top:28vw; margin-left:1.5vw; ">
            ...
            <div style="margin-top:1.5vw;">
                <p style="color:white;"><font style="background-color:transparent; padding:.3vw; border-radius:10px; border: solid 1px white; padding-left:.5vw; padding-right:.5vw; font-weight:600; box-shadow: 2px 2px 23px 0px rgb(0, 0, 0);">ALT</font> <font style="margin-left:.5vw;">Brings up ALT menu</font></p>
            </div>
            <div style="margin-top:1.5vw;">

...
namespace CloudRP.Migrations
{
    ...
    [Migration("20231210110014_Fixed some not mapped columns.")]
    partial class Fixedsomenotmappedcolumns
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CloudRP.Character.DbCharacter", b =>
                {
                    ...
                    b.Property<int?>("characterClothingclothing_id")
                        .HasColumnType("int");

                    b.Property<int?>("characterModelcharacter_model_id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("characterClothingclothing_id");

                    b.HasIndex("characterModelcharacter_model_id");
            ...
            modelBuilder.Entity("CloudRP.Character.DbCharacter", b =>
                {
                    b.HasOne("CloudRP.Character.CharacterClothing", "characterClothing")
                        .WithMany()
                        .HasForeignKey("characterClothingclothing_id");

                    b.HasOne("CloudRP.Character.CharacterModel", "characterModel")
                        .WithMany()
                        .HasForeignKey("characterModelcharacter_model_id");
                });

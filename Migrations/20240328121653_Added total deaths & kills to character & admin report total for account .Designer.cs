...
namespace CloudRP.Migrations
{
    ...
    [Migration("20240328121653_Added total deaths & kills to character & admin report total for account ")]
    partial class Addedtotaldeathskillstocharacteradminreporttotalforaccount
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CloudRP.ServerSystems.Admin.AdminPunishments", b =>
                {
                    b.Property<int>("admin_punishment_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("owner_account_id")
                        .HasColumnType("int");

                    b.Property<string>("punishment_reason")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.Property<int>("punishment_type")
                        .HasColumnType("int");

                    b.Property<long>("unix_expires")
                        .HasColumnType("bigint");

                    b.HasKey("admin_punishment_id");

                    b.ToTable("admin_punishments");
                });
            ...
            modelBuilder.Entity("CloudRP.ServerSystems.Authentication.Account", b =>
                {
                    ...
                    b.Property<string>("admin_jail_reason")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.Property<int>("admin_jail_time")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("has_passed_quiz")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<long>("quiz_fail_unix")
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("ucp_image_url")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.Property<string>("ucp_otp")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");
            ...
            modelBuilder.Entity("CloudRP.ServerSystems.Logging.ServerLog", b =>
                {
                    b.Property<int>("server_log_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("server_log_description")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.Property<string>("server_log_name")
                        .IsRequired()
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.HasKey("server_log_id");

                    b.ToTable("server_logs");
                });
            ...
            modelBuilder.Entity("CloudRP.VehicleSystems.Vehicles.DbVehicle", b =>
                {
                    ...
                    b.Property<int>("dealership_price")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("vehicle_parking_lot_id")
                        .HasColumnType("int");

        ...
        <div class="fixed inset-0 w-full text-white text-lg">
            <div class="container max-w-xl mx-auto mt-[10%]">
                <div class="flex justify-center w-full">
                    <div
                        class="colourBackground rounded-xl text-white w-full colourBackground border-t-4 border-b-4 border-purple-400/50 shadow-2xl shadow-black border-gray-400/40 select-none">

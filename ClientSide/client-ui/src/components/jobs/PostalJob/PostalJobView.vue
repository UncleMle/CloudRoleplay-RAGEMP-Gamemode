                    ...
                    <div class="rounded-xl text-white w-full bg-black/70 shadow-2xl shadow-black select-none">
                        <div class="relative w-full h-fit py-4 rounded-lg">
                            <h1 class="font-bold text-2xl border-b-2 pb-2 border-gray-500 pl-4"><i
                                    class="fa-solid fa-signs-post text-gray-400"></i> Available Postal Jobs</h1>
                            <CloseButton />

                            <div class="overflow-x-hidden overflow-y-scroll max-h-[30vw]">
                                <div v-for="(item, idx) in playerData.postal_jobs" :key="idx"
                                    ...
                                    <div class="absolute w-full bottom-0">
                                        <div class="flex justify-center">
                                            <button @click="startPostalJob(item.jobId)"
...
export default {
    ...
    methods: {
        startPostalJob(id) {
            sendToServer("server:postalJob:selectJob", id);
        }
    }
}
</script>